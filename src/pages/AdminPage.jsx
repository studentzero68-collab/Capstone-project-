      ...
      <main className="admin-main" id="admin-main-content">
            ...
            <div className="admin-stats">
              ...
              <div className="stat-card">
                ...
                <p className="stat-change">
                  From {LISTINGS.reduce((s, l) => s + l.reviews, 0)} reviews
                </p>
              </div>
            </div>
            ...
            <div className="admin-header">
              ...
              <input
                ...
                style={{
                  ...
                  color: 'var(--text-main)', padding: '.5rem 1rem',
        ...
        {activeTab === 'analytics' && (
          <>
            ...
            <div className="admin-stats">
              {[
                { label: 'Page views (Sept)', value: '12,480', change: '+23% vs last month' },
                { label: 'Conversion rate',   value: '3.8%',   change: '+0.4% vs last month' },
                { label: 'Avg. booking value', value: 'R6,001', change: '+5% vs last month'  },
                { label: 'Wishlist saves',     value: '847',    change: '+18% vs last month' },
              ].map(s => (
